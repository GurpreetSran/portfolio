var projects = [
    {
        ...
        description: "<p><a href='http://www.thesun.co.uk/sol/homepage/' target='_blank'>The Sun</a> has the tenth-largest circulation of any newspaper in the world and the largest circulation"+
        			  ...
        			  " 7.3 million.</p>"+
        			  "<p>I have been very fortunate to lead this exciting project. We rewrote entire tired & outdated front end for SUN online and gave it a brand-new look. " +
        ...
        skills: 'Modular JavaScript, jQuery, HTML5, CSS, Flash Builder, Fluid Grid System, Escenic CMS, JSP'  
    },
    {
        ...
        description: "<p><a hre='http://www.thesun.co.uk/sol/homepage/sport/football/' target'_blank'>Sun Football</a> is famous for its brilliant sports-writers and expert columnists.</p>" +
        			  "We made it even bigger & better. The main deliverables of this project was:<ul><li>Football dashboard</li><li>Real time AJAX powered live commentary</li><li>Hand picked tweets from experts</li>" +
        			  "<li>Real time stat widgets</li> <li>Latest pictures available</li><li>Ability to chat with other fans while keeping up with the latest action</li><p></p>",
        skills: 'Modular JavaScript, jQuery, CSS, Escenic CMS, JSP'
    },
    {
        project_url: 'http://gurpreetsran.github.com/ipad-poc/',
        image_url: 'assets/images/ipad-poc-main.jpg',
        description: "<p>This HTML5 based tablet proof of concept project has been done for SUN smart phone team. It was a quick 3 day fun opportunity" +
        			  "to play with new technologies such as HTML5, CSS3, touch events. Management was really impressed with the outcome and they decided to use" +
        			  " about 80% features from this POC.</p> Try it on iPad for: <ul><li>Double finger touch</li><li>Dragging Sections</li><li>Storing Current State</li><li>CSS3 transitions</li></ul><p></p>",
        skills: 'HTML5, CSS3, jQuery, touch-punch'  
    },
    {
        project_url: 'http://www.newsoftheworld.co.uk/',
        image_url: 'assets/images/notw-main.jpg',
        description: "<p>The<a href='http://www.newsoftheworld.co.uk/' target='_blank'> News of the World</a> was a national red top newspaper published in the United Kingdom from 1843 to 2011. It was at one time thebiggest selling English language newspaper in the world, and at closure still had one of the highest English language circulations.</p>" +
        			  "I used to work on this title as Senior Front End developer. I was responsible for:<ul><li>Daily maintenance & bug fixes</li><li>Agile based development</li><li>Adding new features to title</li>"+
        			  "<li>Communication with PO & other stakeholders</li><li>Setting up best practices & documents</li><li></li><li>Mentoring junior developers & contractors</li><li>R&D</li></ul><p></p> ",
        skills: 'Modular JavaScript, jQuery, CSS2, Action Script 3, MXML, Flash, Escenic CMS'
    },
    {
        project_url: 'http://www.thetimes.co.uk/tto/news/',
        image_url: 'assets/images/thetimes-main.jpg',
        description: "<p><a href='http://www.thetimes.co.uk/tto/news/' target='_blank'>The Times</a> is a British daily national newspaper, first published in London in 1785 under the title The Daily Universal Register (it became The Times on 1 January 1788). The Times and its sister paper The Sunday Times (founded in 1821) are published by Times Newspapers, since 1981 a subsidiary of News International, itself wholly owned by the News Corporation group.</p>"+
        			  "I have been working on this title on and off for last two years. My responsibilities include:"+
					  ...
					  "<li>Writing reusable code across all the web titles (The Times, The Sunday Times, The Sun)</li></ul><p></p>",        			  
        skills: 'OO JavaScript, jQuery, CSS, Escenic CMS'  
    },
    {
        project_url: 'http://www.thesundaytimes.co.uk/sto/',
        image_url: 'assets/images/thesundaytimesmain.jpg',
        description: "<p><a href='http://www.thesundaytimes.co.uk/sto/' target='_blank'>The Sunday Times</a> is the largest-selling British national &#39;quality&#39; Sunday newspaper. It is published by Times Newspapers Ltd, a subsidiary of News International, which is in turn owned by News Corporation. Times Newspapers also publishes The Times. The two papers were founded independently and have been under common ownership only since 1966. They were bought by News International in 1981.</p>"+
        			  "I have been working on this title on and off for last two years. My responsibilities include:"+
        			  "<ul><li>Fixing bugs when required</li>"+
        			  "<li>Setting up and maintaining best practices</li>"+
        			  "<li>Code reviews, mentoring junior developers & contractors</li>"+
    ...
    },
    {
        ...
        description: "<p><a href= 'http://www.annarichardson.co.uk/' target='_blank'>Anna's Richardson's</a> Body Blitz Diet is a two week diet plan that guarantees up to 7lb weight loss in just 14 days." + 
        ...
        skills: 'Flash/Flex Builder, Action Script 3, MXML, Elips Studio, XML, Objective C, HTML5'  
    },
    {
        project_url: '',
    ...
    },
    {
        ...
        description: "<p>The UK's most-read weekly glossy, out every Sunday with The Sun newspaper!</p>"+
        			  ...
        			  "<li>Code reviews, mentoring junior developers & contractors</li>"+
					  "<li>Writing reusable code across all the web titles (The Times, The Sunday Times, The Sun)</li></ul><p></p>",        			  
        skills: 'HTML, CSS, Action Script 3, MXML, Escenic CMS'  
    },
    {
...
$(document).ready(function() {
	...
	$('.project').click(function() {
       ...
       if(projects[current_id].project_url != "") {
		...
		projects[current_id].description+ "<p style='font-style: italic'><span style='font-weight: bold;'>Skills Used:</span> "+projects[current_id].skills+"</p>"; 
